...
public class Salesman extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     try{
        ...
        String sql="Insert into salesman" +"(u_id,hiredate)"+ "values(?,?)";
        stmt=conn.prepareStatement(sql);
        stmt.setString(1, uid.getText());
        stmt.setString(2, hiredate.getText()); 
        stmt.executeUpdate();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     try{
        ...
        String sql="UPDATE salesman SET hiredate=? WHERE u_id=?";
        stmt=conn.prepareStatement(sql);
        stmt.setString(2, uid.getText());
        stmt.setString(1, hiredate.getText());
        stmt.executeUpdate();
...
try{
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String sql="DELETE FROM salesman WHERE u_id=?";
        stmt=conn.prepareStatement(sql);
        stmt.setString(1, uid.getText());
        stmt.executeUpdate();
